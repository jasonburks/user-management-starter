...
},{"./collections/UsersCollection":2,"./models/UserModel":3,"./views/UserProfileView":7,"./views/UsersListView":8,"backbone":9}],5:[function(require,module,exports){
...
const UserItemView = Backbone.View.extend({
  ...
  template: _.template(`
    <a class="userLink <%= user.get('activated') ? '' : 'deactivated' %>" href="#users/<%= user.get('_id') %>">
...
},{"backbone":9,"lodash":11}],8:[function(require,module,exports){
const Backbone = require('backbone');
...
},{"../models/UserModel":3,"./UserFormView":5,"./UserItemView":6,"backbone":9}],9:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
